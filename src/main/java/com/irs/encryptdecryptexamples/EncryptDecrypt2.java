...
/**
 * Clase que encripta y desencripta un texto pasado usando la clave como salt de
 * la clave secreta.
 *
 * @autor IRS
 * @version 1.0.0
...
public class EncryptDecrypt2 {
    ...
    public byte[] encrypt(SecretKey secretKey, byte[] text)
        ...
        Cipher cipher = Cipher.getInstance(EncryptDecrypt2.TRANSFORMATION_AES_CBC_PKCS5PADDING);
    ...
    private byte[] getSalt() throws NoSuchAlgorithmException, NoSuchProviderException {
        SecureRandom sr = SecureRandom.getInstance(EncryptDecrypt2.ALGORITHM_SHA1PRNG, "SUN");
    ...
    public SecretKey getKey(String password) throws NoSuchAlgorithmException,
        ...
        SecretKeyFactory factory = SecretKeyFactory.getInstance(
                EncryptDecrypt2.ALGORITHM_PBKDF2_WITH_HMAC_SHA1);
        
        byte[] salt = password.getBytes();
        
        KeySpec spec = new PBEKeySpec(password.toCharArray(), salt, 
                EncryptDecrypt2.ITERATION_COUNT, EncryptDecrypt2.KEY_LEGTH_128);
